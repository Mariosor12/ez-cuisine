  ...
  <section id="feature-pro">
    <div class="container">
      <?php if( get_theme_mod('lzrestaurant_title') != ''){ ?>
        ...
        <img src="<?php echo esc_url(get_theme_mod('food_restaurant_product_sec_border',get_template_directory_uri().'/assets/images/border.png')); ?>" alt="<?php esc_attr_e('Product Title Image','lz-food-recipee') ?>">
      <?php }?>
      ...
      <div class="service-box">
        <div class="restaurant-title">
          <?php if( get_theme_mod('lz_food_recipee_title') != ''){ ?> 
            ...
            <img src="<?php echo esc_url(get_theme_mod('lzrestaurant_product_sec_border',get_template_directory_uri().'/assets/images/border.png')); ?>" alt="<?php esc_attr_e('Restaurant Menu Title Image','lz-food-recipee') ?>">
          <?php }?>
        </div>
        <div class="row">
